/**
 * VENDORED, not written here. Copied verbatim from Claude Code's bundled
 * "dataviz" skill (scripts/validate_palette.js) so that the palette claims in
 * style.css and docs/dsmetrics.html can be re-checked by anyone with this
 * repository, without that skill installed. Re-copy it rather than editing it.
 *
